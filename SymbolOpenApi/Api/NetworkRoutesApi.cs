...
namespace SymbolOpenApi.Api
{
    ...
    /// </summary>
    public interface INetworkRoutesApi : IApiAccessor
    {
    ...
    public partial class NetworkRoutesApi : INetworkRoutesApi
    {
        ...
        public ApiResponse<NetworkConfigurationDTO> GetNetworkPropertiesWithHttpInfo ()
        {
            ...
            var localVarPath = "/network/properties";
            ...
            {
                Exception exception = ExceptionFactory("GetNetworkProperties", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<NetworkConfigurationDTO>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (NetworkConfigurationDTO) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(NetworkConfigurationDTO)));
        }
        ...
        {
             ApiResponse<NetworkConfigurationDTO> localVarResponse = await GetNetworkPropertiesWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        public ApiResponse<NetworkTypeDTO> GetNetworkTypeWithHttpInfo ()
        {
            ...
            return new ApiResponse<NetworkTypeDTO>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (NetworkTypeDTO) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(NetworkTypeDTO)));
        }
        ...
        {
             ApiResponse<NetworkTypeDTO> localVarResponse = await GetNetworkTypeWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        public ApiResponse<RentalFeesDTO> GetRentalFeesWithHttpInfo ()
        {
            ...
            var localVarPath = "/network/fees/rental";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetRentalFees", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<RentalFeesDTO>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (RentalFeesDTO) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(RentalFeesDTO)));
        }
        ...
        {
             ApiResponse<RentalFeesDTO> localVarResponse = await GetRentalFeesWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        ...
        public ApiResponse<TransactionFeesDTO> GetTransactionFeesWithHttpInfo ()
        {
            ...
            var localVarPath = "/network/fees/transaction";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetTransactionFees", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<TransactionFeesDTO>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (TransactionFeesDTO) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(TransactionFeesDTO)));
        }
        ...
        {
             ApiResponse<TransactionFeesDTO> localVarResponse = await GetTransactionFeesWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
