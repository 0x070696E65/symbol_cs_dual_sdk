...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountKeyLinkTransactionBodyDTO :  IEquatable<AccountKeyLinkTransactionBodyDTO>, IValidatableObject
    {
        /// <summary>
        ...
        public AccountKeyLinkTransactionBodyDTO(string linkedPublicKey = default(string), LinkActionEnum linkAction = default(LinkActionEnum))
        {
            ...
            {
                throw new InvalidDataException("linkedPublicKey is a required property for AccountKeyLinkTransactionBodyDTO and cannot be null");
            }
            else
            {
            ...
            if (linkAction == null)
            {
                throw new InvalidDataException("linkAction is a required property for AccountKeyLinkTransactionBodyDTO and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AccountKeyLinkTransactionBodyDTO);
        }

        /// <summary>
        /// Returns true if AccountKeyLinkTransactionBodyDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountKeyLinkTransactionBodyDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountKeyLinkTransactionBodyDTO input)
        {
            if (input == null)
                return false;
