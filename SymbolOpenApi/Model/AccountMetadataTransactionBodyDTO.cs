...
namespace SymbolOpenApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountMetadataTransactionBodyDTO :  IEquatable<AccountMetadataTransactionBodyDTO>, IValidatableObject
    {
        /// <summary>
        ...
        public AccountMetadataTransactionBodyDTO(string targetAddress = default(string), string scopedMetadataKey = default(string), int valueSizeDelta = default(int), long valueSize = default(long), string value = default(string))
        {
            ...
            {
                throw new InvalidDataException("targetAddress is a required property for AccountMetadataTransactionBodyDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("scopedMetadataKey is a required property for AccountMetadataTransactionBodyDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("valueSizeDelta is a required property for AccountMetadataTransactionBodyDTO and cannot be null");
            }
            else
            {
            ...
            if (valueSize == null)
            {
                throw new InvalidDataException("valueSize is a required property for AccountMetadataTransactionBodyDTO and cannot be null");
            }
            else
            {
            ...
            if (value == null)
            {
                throw new InvalidDataException("value is a required property for AccountMetadataTransactionBodyDTO and cannot be null");
            }
            else
            {
                this.Value = value;
        ...
        {
            return this.Equals(input as AccountMetadataTransactionBodyDTO);
        }

        /// <summary>
        /// Returns true if AccountMetadataTransactionBodyDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountMetadataTransactionBodyDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountMetadataTransactionBodyDTO input)
        {
            if (input == null)
                return false;
