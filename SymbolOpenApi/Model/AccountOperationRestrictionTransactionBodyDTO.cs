...
namespace SymbolOpenApi.Model
{
    ...
    public partial class AccountOperationRestrictionTransactionBodyDTO :  IEquatable<AccountOperationRestrictionTransactionBodyDTO>, IValidatableObject
    {
        ...
        public AccountOperationRestrictionTransactionBodyDTO(AccountRestrictionFlagsEnum restrictionFlags = default(AccountRestrictionFlagsEnum), List<TransactionTypeEnum> restrictionAdditions = default(List<TransactionTypeEnum>), List<TransactionTypeEnum> restrictionDeletions = default(List<TransactionTypeEnum>))
        {
            ...
            {
                throw new InvalidDataException("restrictionFlags is a required property for AccountOperationRestrictionTransactionBodyDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("restrictionAdditions is a required property for AccountOperationRestrictionTransactionBodyDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("restrictionDeletions is a required property for AccountOperationRestrictionTransactionBodyDTO and cannot be null");
            }
            else
            {
