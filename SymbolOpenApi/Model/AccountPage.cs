...
namespace SymbolOpenApi.Model
{
    ...
    public partial class AccountPage :  IEquatable<AccountPage>, IValidatableObject
    {
        ...
        public AccountPage(List<AccountInfoDTO> data = default(List<AccountInfoDTO>), Pagination pagination = default(Pagination))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for AccountPage and cannot be null");
            }
            else
            {
                this.Data = data;
            ...
            if (pagination == null)
            {
                throw new InvalidDataException("pagination is a required property for AccountPage and cannot be null");
            }
            else
            {
