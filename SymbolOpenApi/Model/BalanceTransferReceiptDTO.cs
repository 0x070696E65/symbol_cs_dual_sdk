...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BalanceTransferReceiptDTO :  IEquatable<BalanceTransferReceiptDTO>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Type
        /// </summary>
        ...
        public BalanceTransferReceiptDTO(int version = default(int), ReceiptTypeEnum type = default(ReceiptTypeEnum), string mosaicId = default(string), string amount = default(string), string senderAddress = default(string), string recipientAddress = default(string))
        {
            // to ensure "version" is required (not null)
            if (version == null)
            {
                throw new InvalidDataException("version is a required property for BalanceTransferReceiptDTO and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for BalanceTransferReceiptDTO and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (mosaicId == null)
            {
                throw new InvalidDataException("mosaicId is a required property for BalanceTransferReceiptDTO and cannot be null");
            }
            else
            {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for BalanceTransferReceiptDTO and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            {
                throw new InvalidDataException("senderAddress is a required property for BalanceTransferReceiptDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("recipientAddress is a required property for BalanceTransferReceiptDTO and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as BalanceTransferReceiptDTO);
        }

        /// <summary>
        /// Returns true if BalanceTransferReceiptDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of BalanceTransferReceiptDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BalanceTransferReceiptDTO input)
        {
            if (input == null)
                return false;
