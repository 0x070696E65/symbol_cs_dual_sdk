...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmbeddedAccountAddressRestrictionTransactionDTO :  IEquatable<EmbeddedAccountAddressRestrictionTransactionDTO>, IValidatableObject
    {
        /// <summary>
        ...
        public EmbeddedAccountAddressRestrictionTransactionDTO(string signerPublicKey = default(string), int version = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), AccountRestrictionFlagsEnum restrictionFlags = default(AccountRestrictionFlagsEnum), List<string> restrictionAdditions = default(List<string>), List<string> restrictionDeletions = default(List<string>))
        {
            ...
            {
                throw new InvalidDataException("signerPublicKey is a required property for EmbeddedAccountAddressRestrictionTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (version == null)
            {
                throw new InvalidDataException("version is a required property for EmbeddedAccountAddressRestrictionTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (network == null)
            {
                throw new InvalidDataException("network is a required property for EmbeddedAccountAddressRestrictionTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for EmbeddedAccountAddressRestrictionTransactionDTO and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            {
                throw new InvalidDataException("restrictionFlags is a required property for EmbeddedAccountAddressRestrictionTransactionDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("restrictionAdditions is a required property for EmbeddedAccountAddressRestrictionTransactionDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("restrictionDeletions is a required property for EmbeddedAccountAddressRestrictionTransactionDTO and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EmbeddedAccountAddressRestrictionTransactionDTO);
        }

        /// <summary>
        /// Returns true if EmbeddedAccountAddressRestrictionTransactionDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbeddedAccountAddressRestrictionTransactionDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbeddedAccountAddressRestrictionTransactionDTO input)
        {
            if (input == null)
                return false;
