...
namespace SymbolOpenApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmbeddedAccountKeyLinkTransactionDTO :  IEquatable<EmbeddedAccountKeyLinkTransactionDTO>, IValidatableObject
    {
        /// <summary>
        ...
        public EmbeddedAccountKeyLinkTransactionDTO(string signerPublicKey = default(string), int version = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), string linkedPublicKey = default(string), LinkActionEnum linkAction = default(LinkActionEnum))
        {
            // to ensure "signerPublicKey" is required (not null)
            if (signerPublicKey == null)
            {
                throw new InvalidDataException("signerPublicKey is a required property for EmbeddedAccountKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (version == null)
            {
                throw new InvalidDataException("version is a required property for EmbeddedAccountKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (network == null)
            {
                throw new InvalidDataException("network is a required property for EmbeddedAccountKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for EmbeddedAccountKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            {
                throw new InvalidDataException("linkedPublicKey is a required property for EmbeddedAccountKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (linkAction == null)
            {
                throw new InvalidDataException("linkAction is a required property for EmbeddedAccountKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EmbeddedAccountKeyLinkTransactionDTO);
        }

        /// <summary>
        /// Returns true if EmbeddedAccountKeyLinkTransactionDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbeddedAccountKeyLinkTransactionDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbeddedAccountKeyLinkTransactionDTO input)
        {
            if (input == null)
                return false;
