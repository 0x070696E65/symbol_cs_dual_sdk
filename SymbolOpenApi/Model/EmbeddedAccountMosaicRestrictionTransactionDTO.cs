...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EmbeddedAccountMosaicRestrictionTransactionDTO :  IEquatable<EmbeddedAccountMosaicRestrictionTransactionDTO>, IValidatableObject
    {
        /// <summary>
        ...
        public EmbeddedAccountMosaicRestrictionTransactionDTO(string signerPublicKey = default(string), int version = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), AccountRestrictionFlagsEnum restrictionFlags = default(AccountRestrictionFlagsEnum), List<string> restrictionAdditions = default(List<string>), List<string> restrictionDeletions = default(List<string>))
        {
            // to ensure "signerPublicKey" is required (not null)
            if (signerPublicKey == null)
            {
                throw new InvalidDataException("signerPublicKey is a required property for EmbeddedAccountMosaicRestrictionTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (version == null)
            {
                throw new InvalidDataException("version is a required property for EmbeddedAccountMosaicRestrictionTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (network == null)
            {
                throw new InvalidDataException("network is a required property for EmbeddedAccountMosaicRestrictionTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for EmbeddedAccountMosaicRestrictionTransactionDTO and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            {
                throw new InvalidDataException("restrictionFlags is a required property for EmbeddedAccountMosaicRestrictionTransactionDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("restrictionAdditions is a required property for EmbeddedAccountMosaicRestrictionTransactionDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("restrictionDeletions is a required property for EmbeddedAccountMosaicRestrictionTransactionDTO and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as EmbeddedAccountMosaicRestrictionTransactionDTO);
        }

        /// <summary>
        /// Returns true if EmbeddedAccountMosaicRestrictionTransactionDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbeddedAccountMosaicRestrictionTransactionDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbeddedAccountMosaicRestrictionTransactionDTO input)
        {
            if (input == null)
                return false;
