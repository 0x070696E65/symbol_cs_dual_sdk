...
namespace SymbolOpenApi.Model
{
    ...
    public partial class EntityDTO :  IEquatable<EntityDTO>, IValidatableObject
    {
        ...
        public EntityDTO(string signerPublicKey = default(string), int version = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int))
        {
            ...
            {
                throw new InvalidDataException("signerPublicKey is a required property for EntityDTO and cannot be null");
            }
            else
            {
            ...
            if (version == null)
            {
                throw new InvalidDataException("version is a required property for EntityDTO and cannot be null");
            }
            else
            {
            ...
            if (network == null)
            {
                throw new InvalidDataException("network is a required property for EntityDTO and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for EntityDTO and cannot be null");
            }
            else
            {
                this.Type = type;
