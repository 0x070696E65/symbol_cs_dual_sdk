...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HashLockEntryDTO :  IEquatable<HashLockEntryDTO>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        public HashLockEntryDTO(int version = default(int), string ownerAddress = default(string), string mosaicId = default(string), string amount = default(string), string endHeight = default(string), LockStatus status = default(LockStatus), string hash = default(string))
        {
            // to ensure "version" is required (not null)
            if (version == null)
            {
                throw new InvalidDataException("version is a required property for HashLockEntryDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ownerAddress is a required property for HashLockEntryDTO and cannot be null");
            }
            else
            {
            ...
            if (mosaicId == null)
            {
                throw new InvalidDataException("mosaicId is a required property for HashLockEntryDTO and cannot be null");
            }
            else
            {
            ...
            if (amount == null)
            {
                throw new InvalidDataException("amount is a required property for HashLockEntryDTO and cannot be null");
            }
            else
            {
                this.Amount = amount;
            ...
            if (endHeight == null)
            {
                throw new InvalidDataException("endHeight is a required property for HashLockEntryDTO and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for HashLockEntryDTO and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (hash == null)
            {
                throw new InvalidDataException("hash is a required property for HashLockEntryDTO and cannot be null");
            }
            else
            {
                this.Hash = hash;
        ...
        {
            return this.Equals(input as HashLockEntryDTO);
        }

        /// <summary>
        /// Returns true if HashLockEntryDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of HashLockEntryDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HashLockEntryDTO input)
        {
            if (input == null)
                return false;
