...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MosaicRestrictionDTO :  IEquatable<MosaicRestrictionDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MosaicRestrictionDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MosaicRestrictionDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MosaicRestrictionDTO" /> class.
        /// </summary>
        ...
        public MosaicRestrictionDTO(string id = default(string), MosaicGlobalRestrictionEntryWrapperDTO mosaicRestrictionEntry = default(MosaicGlobalRestrictionEntryWrapperDTO))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for MosaicRestrictionDTO and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            {
                throw new InvalidDataException("mosaicRestrictionEntry is a required property for MosaicRestrictionDTO and cannot be null");
            }
            else
            {
