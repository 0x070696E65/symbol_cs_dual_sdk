...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class NodeHealthDTO :  IEquatable<NodeHealthDTO>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name="apiNode", EmitDefaultValue=true)]
        ...
        {
            // to ensure "apiNode" is required (not null)
            if (apiNode == null)
            {
                throw new InvalidDataException("apiNode is a required property for NodeHealthDTO and cannot be null");
            }
            else
            {
            ...
            if (db == null)
            {
                throw new InvalidDataException("db is a required property for NodeHealthDTO and cannot be null");
            }
            else
            {
                this.Db = db;
