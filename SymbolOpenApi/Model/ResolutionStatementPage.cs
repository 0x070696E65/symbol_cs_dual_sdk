...
namespace SymbolOpenApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ResolutionStatementPage :  IEquatable<ResolutionStatementPage>, IValidatableObject
    {
        /// <summary>
        ...
        public ResolutionStatementPage(List<ResolutionStatementInfoDTO> data = default(List<ResolutionStatementInfoDTO>), Pagination pagination = default(Pagination))
        {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for ResolutionStatementPage and cannot be null");
            }
            else
            {
                this.Data = data;
            ...
            if (pagination == null)
            {
                throw new InvalidDataException("pagination is a required property for ResolutionStatementPage and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ResolutionStatementPage);
        }

        /// <summary>
        /// Returns true if ResolutionStatementPage instances are equal
        /// </summary>
        /// <param name="input">Instance of ResolutionStatementPage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResolutionStatementPage input)
        {
            if (input == null)
                return false;
