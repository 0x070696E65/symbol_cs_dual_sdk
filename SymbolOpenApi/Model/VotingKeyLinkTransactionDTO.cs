...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class VotingKeyLinkTransactionDTO :  IEquatable<VotingKeyLinkTransactionDTO>, IValidatableObject
    {
        /// <summary>
        ...
        public VotingKeyLinkTransactionDTO(long size = default(long), string signature = default(string), string signerPublicKey = default(string), int version = default(int), NetworkTypeEnum network = default(NetworkTypeEnum), int type = default(int), string maxFee = default(string), string deadline = default(string), string linkedPublicKey = default(string), long startEpoch = default(long), long endEpoch = default(long), LinkActionEnum linkAction = default(LinkActionEnum))
        {
            // to ensure "size" is required (not null)
            if (size == null)
            {
                throw new InvalidDataException("size is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
                this.Size = size;
            ...
            if (signature == null)
            {
                throw new InvalidDataException("signature is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("signerPublicKey is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (version == null)
            {
                throw new InvalidDataException("version is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (network == null)
            {
                throw new InvalidDataException("network is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (maxFee == null)
            {
                throw new InvalidDataException("maxFee is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
                this.MaxFee = maxFee;
            ...
            if (deadline == null)
            {
                throw new InvalidDataException("deadline is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("linkedPublicKey is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (startEpoch == null)
            {
                throw new InvalidDataException("startEpoch is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (endEpoch == null)
            {
                throw new InvalidDataException("endEpoch is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
            ...
            if (linkAction == null)
            {
                throw new InvalidDataException("linkAction is a required property for VotingKeyLinkTransactionDTO and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as VotingKeyLinkTransactionDTO);
        }

        /// <summary>
        /// Returns true if VotingKeyLinkTransactionDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of VotingKeyLinkTransactionDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VotingKeyLinkTransactionDTO input)
        {
            if (input == null)
                return false;
