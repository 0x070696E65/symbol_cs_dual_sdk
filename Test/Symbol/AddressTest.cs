...
public class AddressTest
{
	...
	public void AddressTest0(){
		...
		var mainAddress = Converter.AddressToString(MainFacade.Network.PublicKeyToAddress(publicKey).bytes);
		var testAddress = Converter.AddressToString(TestFacade.Network.PublicKeyToAddress(publicKey).bytes);
