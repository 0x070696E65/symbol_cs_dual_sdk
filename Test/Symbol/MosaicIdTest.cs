...
public class MosaicIdTest
{
	...
	public void MosaicIdTest0(){
		...
		var mainAd = MainFacade.TransactionFactory.Network.PublicKeyToAddress(Converter.HexToUint8(publicKey));
		var mainAddress = Converter.AddressToString(mainAd.bytes);
		var testAd = TestFacade.TransactionFactory.Network.PublicKeyToAddress(Converter.HexToUint8(publicKey));
