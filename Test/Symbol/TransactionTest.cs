...
public class TransactionTest
{
	...
	public void AccountAddressRestrictionTransaction_account_address_restriction_single_1(){
		...
		var tx = new AccountAddressRestrictionTransaction {
			...
			RestrictionFlags = 
				new AccountRestrictionFlags((ushort)new[] {
	...
	public void AccountAddressRestrictionTransaction_account_address_restriction_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedAccountAddressRestrictionTransaction {
					Network = NetworkType.TESTNET,
					RestrictionFlags = 
						new AccountRestrictionFlags((ushort)new[] {
							AccountRestrictionFlags.ADDRESS,
	...
	public void AccountKeyLinkTransaction_account_key_link_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedAccountKeyLinkTransaction {
					Network = NetworkType.TESTNET,
					LinkedPublicKey = new PublicKey(Converter.HexToBytes("F6503F78FBF99544B906872DDB392F4BE707180D285E7919DBACEF2E9573B1E6")),
					LinkAction = LinkAction.LINK,
				},
	...
	public void AccountMetadataTransaction_account_metadata_single_2(){
		...
		var tx = new AccountMetadataTransaction {
			...
			ValueSizeDelta = unchecked((ushort) (-6 - 0xFFFF0000)),
			Value = Converter.HexToBytes("313233424143"),
	...
	public void AccountMetadataTransaction_account_metadata_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedAccountMetadataTransaction {
					Network = NetworkType.TESTNET,
					TargetAddress = new UnresolvedAddress(Converter.StringToAddress("TBA6LOHEA6A465G2X5MSQF66JBYR254GJDPK7MQ")),
					ScopedMetadataKey = 10,
					ValueSizeDelta = 10,
	...
	public void AccountMosaicRestrictionTransaction_account_mosaic_restriction_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedAccountMosaicRestrictionTransaction {
					Network = NetworkType.TESTNET,
					RestrictionFlags = 
						new AccountRestrictionFlags((ushort)new[] {
							AccountRestrictionFlags.MOSAIC_ID,
	...
	public void AccountOperationRestrictionTransaction_account_operation_restriction_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedAccountOperationRestrictionTransaction {
					Network = NetworkType.TESTNET,
					RestrictionFlags = 
						new AccountRestrictionFlags((ushort)new[] {
							AccountRestrictionFlags.OUTGOING,
	...
	public void AddressAliasTransaction_address_alias_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedAddressAliasTransaction {
					Network = NetworkType.TESTNET,
					NamespaceId = new NamespaceId(9562080086528621131),
					Address = new Address(Converter.StringToAddress("TBA6LOHEA6A465G2X5MSQF66JBYR254GJDPK7MQ")),
					AliasAction = AliasAction.LINK,
		...
		var tx = new AggregateBondedTransaction {
			...
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedTransferTransaction {
					Network = NetworkType.TESTNET,
					RecipientAddress = new UnresolvedAddress(Converter.StringToAddress("TBA6LOHEA6A465G2X5MSQF66JBYR254GJDPK7MQ")),
					Mosaics = 
				...
				new EmbeddedMosaicSupplyChangeTransaction {
					Network = NetworkType.TESTNET,
	...
	public void AggregateCompleteTransaction_aggregate_complete_agregate_1(){
		...
		var tx = new AggregateCompleteTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedTransferTransaction {
					Network = NetworkType.TESTNET,
				...
				new EmbeddedTransferTransaction {
					Network = NetworkType.TESTNET,
					RecipientAddress = new UnresolvedAddress(Converter.StringToAddress("TCIFSMQZAX3IDPHUP2RTXP26N6BJRNKEBBKP33I")),
					Mosaics = 
						new UnresolvedMosaic[]{
								new (){
									MosaicId = new UnresolvedMosaicId(95442763262823),
					...
					,
					Message = Converter.HexToBytes("D600000300504C5445000000FBAF93F7"),
				},
			},
	...
	public void HashLockTransaction_hash_lock_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedHashLockTransaction {
					Network = NetworkType.TESTNET,
					Mosaic = 
						new UnresolvedMosaic{
							MosaicId = new UnresolvedMosaicId(9636553580561478212),
	...
	public void MosaicAddressRestrictionTransaction_mosaic_address_restriction_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedMosaicAddressRestrictionTransaction {
					Network = NetworkType.TESTNET,
					MosaicId = new UnresolvedMosaicId(1),
					RestrictionKey = 1311768467294898927,
					PreviousRestrictionValue = 9,
	...
	public void MosaicAliasTransaction_mosaic_alias_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedMosaicAliasTransaction {
					Network = NetworkType.TESTNET,
					NamespaceId = new NamespaceId(13182596108967839652),
					MosaicId = new MosaicId(10),
					AliasAction = AliasAction.LINK,
	...
	public void MosaicDefinitionTransaction_mosaic_definition_single_1(){
		...
		var tx = new MosaicDefinitionTransaction {
			...
			Fee = new Amount(18370164183782063840),
			Deadline = new Timestamp(8207562320463688160),
			Id = new MosaicId(IdGenerator.GenerateMosaicId(Facade.Network.PublicKeyToAddress("aee04b25fdf56040d4ef1bef806f3a4e55c334e6022e27de823564baab952424"), 0)),
		};
		Assert.AreEqual(payload, Converter.BytesToHex(tx.Serialize()));
	}
	[Test]
	public void MosaicDefinitionTransaction_mosaic_definition_single_2(){
		...
		var tx = new MosaicDefinitionTransaction {
			...
			Fee = new Amount(18370164183782063840),
			Deadline = new Timestamp(8207562320463688160),
			Id = new MosaicId(IdGenerator.GenerateMosaicId(Facade.Network.PublicKeyToAddress("d36b5d35e666e136d82b9ee3cf26c02dc7b9ecd0c8c287b98c7e245989c5699d"), 3095715558)),
		};
		Assert.AreEqual(payload, Converter.BytesToHex(tx.Serialize()));
	}
	[Test]
	public void MosaicDefinitionTransaction_mosaic_definition_single_3(){
		...
		var tx = new MosaicDefinitionTransaction {
			...
			Fee = new Amount(18370164183782063840),
			Deadline = new Timestamp(8207562320463688160),
			Id = new MosaicId(IdGenerator.GenerateMosaicId(Facade.Network.PublicKeyToAddress("82602ecac9835b208d88822ad0885ba87372cf660ac12a6f1eb6cdc19133a50c"), 3095715558)),
		};
		Assert.AreEqual(payload, Converter.BytesToHex(tx.Serialize()));
	}
	[Test]
	public void MosaicDefinitionTransaction_mosaic_definition_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedMosaicDefinitionTransaction {
					Network = NetworkType.TESTNET,
					Duration = new BlockDuration(10000),
					Nonce = new MosaicNonce(0),
					Flags = 
	...
	public void MosaicGlobalRestrictionTransaction_mosaic_global_restriction_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedMosaicGlobalRestrictionTransaction {
					Network = NetworkType.TESTNET,
					MosaicId = new UnresolvedMosaicId(1875072453572000775),
					ReferenceMosaicId = new UnresolvedMosaicId(7706325451784159270),
					RestrictionKey = 1,
	...
	public void MosaicMetadataTransaction_mosaic_metadata_single_2(){
		...
		var tx = new MosaicMetadataTransaction {
			...
			ScopedMetadataKey = 10,
			TargetMosaicId = new UnresolvedMosaicId(1000),
			ValueSizeDelta = unchecked((ushort) (-5 - 0xFFFF0000)),
			Value = Converter.HexToBytes("313233414243"),
	...
	public void MosaicMetadataTransaction_mosaic_metadata_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedMosaicMetadataTransaction {
					Network = NetworkType.TESTNET,
					TargetAddress = new UnresolvedAddress(Converter.StringToAddress("TBA6LOHEA6A465G2X5MSQF66JBYR254GJDPK7MQ")),
					ScopedMetadataKey = 10,
					TargetMosaicId = new UnresolvedMosaicId(1000),
	...
	public void MultisigAccountModificationTransaction_multisig_account_modification_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedMultisigAccountModificationTransaction {
					Network = NetworkType.TESTNET,
					MinRemovalDelta = 1,
					MinApprovalDelta = 2,
					AddressAdditions = 	new UnresolvedAddress[]{
	...
	public void NamespaceMetadataTransaction_namespace_metadata_single_2(){
		...
		var tx = new NamespaceMetadataTransaction {
			...
			ScopedMetadataKey = 10,
			TargetNamespaceId = new NamespaceId(1000),
			ValueSizeDelta = unchecked((ushort) (-3 - 0xFFFF0000)),
			Value = Converter.Utf8ToBytes("ABC123"),
	...
	public void NamespaceMetadataTransaction_namespace_metadata_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedNamespaceMetadataTransaction {
					Network = NetworkType.TESTNET,
					TargetAddress = new UnresolvedAddress(Converter.StringToAddress("TCIFSMQZAX3IDPHUP2RTXP26N6BJRNKEBBKP33I")),
					ScopedMetadataKey = 10,
					TargetNamespaceId = new NamespaceId(1000),
	...
	public void NamespaceRegistrationTransaction_namespace_registration_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedNamespaceRegistrationTransaction {
					Network = NetworkType.TESTNET,
					Duration = new BlockDuration(10000),
					Id = new NamespaceId(13858666424160217470),
					RegistrationType = NamespaceRegistrationType.ROOT,
	...
	public void NodeKeyLinkTransaction_node_key_link_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedNodeKeyLinkTransaction {
					Network = NetworkType.TESTNET,
					LinkedPublicKey = new PublicKey(Converter.HexToBytes("9801508C58666C746F471538E43002B85B1CD542F9874B2861183919BA8787B6")),
					LinkAction = LinkAction.LINK,
				},
	...
	public void SecretLockTransaction_secret_lock_single_1(){
		...
		var tx = new SecretLockTransaction {
			Network = NetworkType.TESTNET,
			RecipientAddress = new UnresolvedAddress(Converter.StringToAddress("TBA6LOHEA6A465G2X5MSQF66JBYR254GJDPK7MQ")),
			Secret = new Hash256(Converter.HexToBytes("3FC8BA10229AB5778D05D9C4B7F56676A88BF9295C185ACFC0F961DB5408CAFE")),
			Mosaic = 
				new UnresolvedMosaic{
					MosaicId = new UnresolvedMosaicId(9636553580561478212),
					Amount = new Amount(10000000),
	...
	public void SecretLockTransaction_secret_lock_single_2(){
		...
		var tx = new SecretLockTransaction {
			...
			,
			Duration = new BlockDuration(100),
			Secret = new Hash256(Converter.HexToBytes("59CC35F8C8D91867717CE4290B40EA636E86CE5C000000000000000000000000")),
	...
	public void SecretLockTransaction_secret_lock_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedSecretLockTransaction {
					Network = NetworkType.TESTNET,
					RecipientAddress = new UnresolvedAddress(Converter.StringToAddress("TBA6LOHEA6A465G2X5MSQF66JBYR254GJDPK7MQ")),
					Secret = new Hash256(Converter.HexToBytes("3FC8BA10229AB5778D05D9C4B7F56676A88BF9295C185ACFC0F961DB5408CAFE")),
					Mosaic = 
	...
	public void SecretProofTransaction_secret_proof_single_1(){
		...
		var tx = new SecretProofTransaction {
			...
			Secret = new Hash256(Converter.HexToBytes("3FC8BA10229AB5778D05D9C4B7F56676A88BF9295C185ACFC0F961DB5408CAFE")),
			HashAlgorithm = LockHashAlgorithm.SHA3_256,
			Proof = Converter.HexToBytes("9A493664"),
	...
	public void SecretProofTransaction_secret_proof_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedSecretProofTransaction {
					Network = NetworkType.TESTNET,
					RecipientAddress = new UnresolvedAddress(Converter.StringToAddress("TCIFSMQZAX3IDPHUP2RTXP26N6BJRNKEBBKP33I")),
					Secret = new Hash256(Converter.HexToBytes("3FC8BA10229AB5778D05D9C4B7F56676A88BF9295C185ACFC0F961DB5408CAFE")),
					HashAlgorithm = LockHashAlgorithm.SHA3_256,
	...
	public void TransferTransaction_transfer_single_5(){
		...
		var tx = new TransferTransaction {
			Network = NetworkType.TESTNET,
			RecipientAddress = new UnresolvedAddress(Converter.StringToAddress("SGEN27LSEJ7MVZYAAAAAAAAAAAAAAAAAAAAAAAA")),
			Mosaics = 
				new UnresolvedMosaic[]{
						new (){
							MosaicId = new UnresolvedMosaicId(9636553580561478212),
	...
	public void VotingKeyLinkTransaction_voting_key_link_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedVotingKeyLinkTransaction {
					Network = NetworkType.TESTNET,
					LinkedPublicKey = new VotingPublicKey(Converter.HexToBytes("C614558647D02037384A2FECA80ACE95B235D9B9D90035FA46102FE79ECCBA75")),
					StartEpoch = new FinalizationEpoch(1),
					EndEpoch = new FinalizationEpoch(3),
	...
	public void VrfKeyLinkTransaction_vrf_key_link_agregate_1(){
		...
		var tx = new AggregateBondedTransaction {
			Network = NetworkType.TESTNET,
			Transactions = 	new IBaseTransaction[]{
				new EmbeddedVrfKeyLinkTransaction {
					Network = NetworkType.TESTNET,
					LinkedPublicKey = new PublicKey(Converter.HexToBytes("9801508C58666C746F471538E43002B85B1CD542F9874B2861183919BA8787B6")),
					LinkAction = LinkAction.LINK,
				},
